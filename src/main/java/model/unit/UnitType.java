...
public enum UnitType {
    ...
    KNIGHT(40, 12, 6,2,15,0, Weapons.SWORDS, Weapons.METAL_ARMOUR, false,new Image(UnitType.class.getResource("/images/unit/menu/KNIGHT.png").toExternalForm()), "knight"),
    ...
    SLINGERS(10, 5, 3, 3 ,5, 1, null ,null, false ,new Image(UnitType.class.getResource("/images/unit/menu/SLINGERS.png").toExternalForm()), "worker"),
    ASSASSINS(30, 10, 4, 1 ,9, 1, null ,null, false,new Image(UnitType.class.getResource("/images/unit/menu/ASSASSINS.png").toExternalForm()), "swordsman"),
    HORSE_ARCHERS(30, 10, 6, 5 , 12, 1, null ,null, true,new Image(UnitType.class.getResource("/images/unit/menu/HORSE_ARCHERS.png").toExternalForm()), "knight"),
    ARABIAN_SWORDSMAN(40, 12, 2, 1 ,16, 1, null ,null, false,new Image(UnitType.class.getResource("/images/unit/menu/ARABIAN_SWORDSMAN.png").toExternalForm()), "swordsman"),
    FIRE_THROWERS(20, 15, 3, 3 , 9,1, null ,null, true,new Image(UnitType.class.getResource("/images/unit/menu/FIRE_THROWERS.png").toExternalForm()), "slave"),
