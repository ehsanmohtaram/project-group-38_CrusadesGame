...
public enum UnitType {
    ...
    TUNNELER(15, 8, 4 , 1 ,5, -1, null, null, false,new Image(UnitType.class.getResource("/images/unit/menu/ARCHER.png").toExternalForm())),
    LADDER_MAN(10, 0, 4,1,4, -1,Weapons.LADDER,null, false,new Image(UnitType.class.getResource("/images/unit/menu/ARCHER.png").toExternalForm())),
    ENGINEER(10 , 15 , 3, 1,4, -1, null, null, null,new Image(UnitType.class.getResource("/images/unit/menu/ARCHER.png").toExternalForm())),
    WORKER(10 , 0 ,3 , 0, 4, -1 , null, null, null,new Image(UnitType.class.getResource("/images/unit/menu/ARCHER.png").toExternalForm())),
