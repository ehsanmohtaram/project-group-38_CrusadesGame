...
public enum UnitType {
    ...
    CROSSBOWMEN(30, 5, 2, 3, 7,0, Weapons.CROSSBOW, Weapons.LEATHER_ARMOUR, true),
    SPEAR_MAN(10, 10, 3, 1, 5,0,Weapons.SPEAR,null, false),
    PIKE_MAN(40, 10, 2, 2, 10, 0, Weapons.SPEAR, Weapons.METAL_ARMOUR, false),
    MACE_MAN(30,15,3, 1, 13,0,Weapons.MACE, Weapons.LEATHER_ARMOUR, false),
    SWORDSMEN(10, 20, 1,1,8,0, Weapons.SWORDS, Weapons.METAL_ARMOUR, false),
    KNIGHT(40, 20, 5,2,15,0, Weapons.SWORDS, Weapons.METAL_ARMOUR, false),
    TUNNELER(10, 10, 4 , 1 ,5, -1, null, null, false),
    LADDER_MAN(10, 0, 4,1,4, -1,Weapons.LADDER,null, false),
    ENGINEER(10 , 0 , 3, 0,4, -1, null, null, null),
    WORKER(10 , 0 ,3 , 0, 4, -1 , null, null, null),
    BLACK_MONK(30, 10, 2, 1 ,8, 0, Weapons.MACE, null, false),
    ARCHER_BOW(20, 5, 4, 5 ,7, 1, null ,null, true),
